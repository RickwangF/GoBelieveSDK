...
#define COL_ISMUTE is_mute
#define COL_ATMSG atmsg
...
#define ALL_COL                                                                                                        \
    comma(COL_UID, COL_AVATARURL, COL_NAME, COL_TIMESTAMP, COL_CONTENT, COL_MSGUUID, COL_ISCALLBACK, COL_ISGROUP,      \
          ...
          COL_UNSENDTAG, COL_TARGETID, COL_IS_SELF, COL_AREA, COL_REMARKNAME, COL_CONVERSATION_TYPE, COL_ISMUTE, COL_ATMSG)
